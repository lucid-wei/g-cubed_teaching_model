...
| StableManifoldTolerance               | 1e-9               | By use case        | Convergence criterion when solving for the stable manifold. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.stable_manifold_tolerance)                      | If H1 or H2 matrix alters in magnitude larger than this value, iteration continues, see [gcubed.linearisation.stable_manifold.StableManifold](./gcubed/linearisation/stable_manifold.html#gcubed.linearisation.stable_manifold.StableManifold.solve).                            |
