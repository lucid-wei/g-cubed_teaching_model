...
| Debugging                             | 1                  | 0                                | Set to 1 if debugging and 0 otherwise. This affects model logging verbosity. [Location in source code]()                                                                                                     | Impact the amount of information you see in log file and terminal. (A feature under development, currently has no big impact for gcubed-1.0.0)                                                                                                                                                                           |
...
| LinearisationYear                     | 2011               | Not available                    | Year around which the baseline model is linearised. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.linearisation_year)                            | Used to transform the model from non-linear to linear at the specified year by [gcubed.linearisation.linear_model.LinearModel](./gcubed/linearisation/linear_model.html), so that the model can be solved.                                                                                                               |
| CalibrationOfCarbonCoefficientsYear   | 2015               | Not available                    | The year used to calibrate carbon emissions coefficients. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.calibration_of_carbon_coefficients_year) | Used to read emissions parameters by __set_emissions_parameters() in [gcubed.model_parameters.parameters.Parameters](./gcubed/model_parameters/parameters.html).                                                                                                                                                         |
| StartYear (TODO to eliminate)         | 2018               | Not available                    | Should be from the last year of available data but right now that is 2018. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.start_year)             | Used in __configure_ROGY() to set lagged_region_SHL in [gcubed.baseline.effective_labour_productivity.EffectiveLabourProductivity](./gcubed/baseline/effective_labour_productivity.html) and _create_productivity_projections() in [ gcubed.baseline.productivity.Productivity](./gcubed/baseline/productivity.html).    |
| EndYear                               | 2100               | Any year further into the future | End year for projections. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.end_year)                                                                | Used intensively in functions relating to projections. e.g. _create_productivity_projections() in [gcubed.baseline.productivity.Productivity](./gcubed/baseline/productivity.html).                                                                                                                                      |
| FirstAvailableYear (can be read)      | 1996               | Not available                    | The first year for which we have actual data rather than projections. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.first_available_year)        | Used in generating graphable_projections in [gcubed.projections.projections.Projections](./gcubed/projections/projections.html#gcubed.projections.projections.Projections.graphable_projections).                                                                                                                        |
| LastAvailableYear  (redundant)        | 2021               | Not available                    | The last year for which we have actual data rather than projections. [Location in source code](./gcubed/model_configuration.html#gcubed.model_configuration.ModelConfiguration.last_available_year)          |                                                                                                                                                                                                                                                                                                                          |
|                                       |                    |                                  |                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                          |
|                                       |                    |                                  |                                                                                                                                                                                                              |                                                                                                                                                                                                                                                                                                                          |
